...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({
        ...
        description: 'Supports structured filters and/or a natural-language `q` param. ' +
            'Results are AI-ranked when sortBy=ai (default). Falls back to rating sort if AI is unavailable.',
    }),
    __param(0, (0, common_1.Query)()),
    __param(1, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [search_providers_dto_1.SearchProvidersDto, Object]),
