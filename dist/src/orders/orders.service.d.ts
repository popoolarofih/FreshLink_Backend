...
export declare class OrdersService {
    ...
    constructor(prisma: PrismaService, notifications: NotificationsService, aiClient: AiClientService, ordersQueue: Queue);
    ...
    requestContractDraft(orderId: string, requesterId: string): Promise<import("../ai-client/ai-client.types").ContractDraft>;
}
